...
<div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-9 personal-info">
        <h3>Pendaftaran Dokter</h3>
        
        <form action="<?php echo base_url(); ?>/masuk/tambah_dokter" method="post" class="form-horizontal" role="form">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" name="tempat" type="text" value="">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label">Alamat Rumah: </label>
            <div class="col-lg-8">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" name="jam" type="text" value="">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Hari Libur Praktek</label>
            <div class="col-lg-8">
              <input class="form-control" name="libur" type="text" value="">
            </div>
          </div>
          <div class="form-group">
      ...
      <div class="container text-center" id="kontak">
        <div class="row">
          <div class="col-sm-12">
            ...
            <i class="glyphicon glyphicon-heart"></i> by. <a href="http://instagram.com/rachmadi_15">MESSY</a>.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12">
