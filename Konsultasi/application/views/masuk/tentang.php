...
<html lang="en">
  ...
  <body>
     ...
     <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target sticky-top" id="ftco-navbar">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav nav ml-auto">
              <li class="nav-item link1" style="padding: 10px;"><a class="nav-link link a1" href="<?=site_url('masuk')?>">Beranda</a></li>
              <li class="nav-item link1" style="padding: 10px;"><a class="nav-link a1" href="<?=site_url('masuk/berita')?>">Berita</a></li>
              <li class="nav-item link1" style="padding: 10px;"><a class="nav-link a1" href="<?=site_url('masuk/dokter')?>">Jadwal</a></li>
              <li class="nav-item link1" style="padding: 10px;"><a class="nav-link a1" href="<?=site_url('masuk/tentang')?>">Tentang</a></li>
      ...
      <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid div1 mb-5" style="background-color: #44749d">
        <div class="container">
          ...
          <a class="nav-link" href="#deskripsi" style="margin-left: 480px; margin-top: 50px;"><button class="btn btn-warning">Selengkapnya</button></a>
        </div>
      </div>
