            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?=site_url('chat/pasien2/').$u->id_pasien?>" class="btn btn-warning">Pesan</a>
                            </td>
                        <td><a href="<?=site_url('psikiater/hapus/').$u->id_pasien?>" class="btn btn-danger">Hapus</a></td>
